...
export const routes: Routes = [
  { path: '', component: Home },
  { path: 'products/tents', component: ProductList },
  { path: 'products/backpacks', component: ProductList },
  { path: 'products/sleeping-bags', component: ProductList },
  { path: 'products/hammocks', component: ProductList },
  { path: 'products/:category', component: ProductList },
  { path: 'product/:id', component: ProductDetail },
  { path: 'cart', component: Cart },
  { path: 'checkout', component: Checkout },
  { path: 'checkout/success', component: CheckoutSuccess },
  { path: 'admin/orders', component: Admin },
  { path: '**', redirectTo: '/' }
];
